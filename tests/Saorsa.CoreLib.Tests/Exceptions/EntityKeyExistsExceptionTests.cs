...
public class EntityKeyExistsExceptionTests
{
    [Test]
    public void TestConstructor()
    {
        ...
        var exception = new EntityKeyAlreadyExistsException(key, message);
    ...
    public void TestConstructorWithInnerException()
    {
        var key = Guid.NewGuid().ToString("D");
        var message = Guid.NewGuid().ToString("D");
        var exception = new EntityKeyAlreadyExistsException(key, message, new Exception());
